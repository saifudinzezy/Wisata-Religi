...
public class Petilasan extends AppCompatActivity implements SearchView.OnQueryTextListener, WisataAdapter.OnFunction{
            ...
            public void onResponse(Call<ResponseWisata> call, Response<ResponseWisata> response) {
                ...
                if (response.body().getResponse().equalsIgnoreCase(SUCCESS)) {
                    try {
                        ...
                        adapter = new WisataAdapter(Petilasan.this, list, Petilasan.this);
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText == null || newText.trim().isEmpty()) {
            adapter = new WisataAdapter(Petilasan.this, hasilPesan, Petilasan.this);
            rv.setAdapter(adapter);
            return false;
        }
    ...
    @Override
    public void onDelete(WisataItem data) {
        delete(data);
    }
