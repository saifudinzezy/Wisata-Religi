...
public class Acara extends AppCompatActivity implements SearchView.OnQueryTextListener, AcaraAdapter.OnFunction {
    ...
    private void getAcara(String cek) {
        ...
        Call<ResponseAcara> call;

        if (cek.equalsIgnoreCase("0")) {
            call = apiService.getAcara();
        } else {
            call = apiService.getAcaraId(cek);
        }
            ...
            public void onResponse(Call<ResponseAcara> call, Response<ResponseAcara> response) {
                ...
                if (response.body().getResponse().equalsIgnoreCase(SUCCESS)) {
                    try {
                        ...
                        adapter = new AcaraAdapter(Acara.this, list, Acara.this);
                    ...
                    Toast.makeText(Acara.this, "Data Kosong!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText == null || newText.trim().isEmpty()) {
            adapter = new AcaraAdapter(Acara.this, hasilPesan, this);
            rv.setAdapter(adapter);
            return false;
        }
    ...
    public void onViewClicked() {
        startActivity(new Intent(Acara.this, AddAcara.class));
    }
            ...
            public void onResponse(Call<ResponseWisata> call, Response<ResponseWisata> response) {
                ...
                if (response.body().getResponse().equalsIgnoreCase(SUCCESS)) {
                    try {
                        ...
                        adapterSpiner = new CustomAdapter(Acara.this, hasilPesanSpiner);
    ...
    @Override
    public void onDelete(AcaraItem data) {
        delete(data);
    }

    private void delete(final AcaraItem data) {
        //buat object alarm
        AlertDialog.Builder aleBuilder = new AlertDialog.Builder(Acara.this);
        ...
        aleBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        adapter.hapusData(data.getIdAcara(), "acara", "id_acara");
                        getWisata();
                    }
                })
